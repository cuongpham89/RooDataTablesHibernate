...
import org.pablog.bookdb.web.BookController;
...
privileged aspect BookController_Roo_Controller {
    ...
    void BookController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("book_datepublished_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
